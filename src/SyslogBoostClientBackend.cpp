 ...
 * @brief Файл содержит определение функций класса класса для реализации механизма передачи сообщений по протоколу Syslog с использованием библиотеки boost::log
 * @version 0.1
 * @date 2024-12-07
 *
